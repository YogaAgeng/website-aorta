...
@section('title', 'Edit Project: ' . $project->judul)

@section('header')
    <h5 class="mb-0">Edit Project: {{ $project->judul }}</h5>
@endsection
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                     id="deskripsi" name="deskripsi" rows="3" required>{{ old('deskripsi', $project->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control summernote @error('konten') is-invalid @enderror" 
                                     id="konten" name="konten" rows="10" required>{{ old('konten', $project->konten) }}</textarea>
                            @error('konten')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    @if($project->gambar)
                                        <div class="image-preview mb-2">
                                            <img id="imagePreview" src="{{ asset('storage/' . $project->gambar) }}" alt="Preview" class="img-fluid rounded">
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kategori') is-invalid @enderror" 
                                           id="kategori" name="kategori" value="{{ old('kategori', $project->kategori) }}" required>
                                    @error('kategori')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_selesai') is-invalid @enderror" 
                                           ...
                                           value="{{ old('tanggal_selesai', $project->tanggal_selesai ? $project->tanggal_selesai->format('Y-m-d') : '') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" 
                                        ...
                                        <option value="berlangsung" {{ old('status', $project->status) == 'berlangsung' ? 'selected' : '' }}>Berlangsung</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('target_donasi') is-invalid @enderror" 
                                               id="target_donasi" name="target_donasi" 
                                               value="{{ old('target_donasi', $project->target_donasi) }}" min="0">
                                    </div>
                                    @error('target_donasi')
                                ...
                                <div class="mb-3">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <strong>Rp {{ number_format($project->donasi_terkumpul, 0, ',', '.') }}</strong>
                                    </div>
                                ...
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bi bi-save me-1"></i> Perbarui Project
                                    </button>
